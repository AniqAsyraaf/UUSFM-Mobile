...
class SignUpScreen extends StatefulWidget {
  ...
  const SignUpScreen({Key key, this.showLoginScreen, this.userviewmodel})
      : super(key: key);
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future signUp() async {
    ...
    if (_emailController.text.isNotEmpty &
      ...
      String res =
          await _registerviewmodel.checkEmail(_emailController.text.trim());
      print(res);

      if (res == "available") {
        if (passwordConfirmed()) {
          String res = await _registerviewmodel.register(
          ...
          if (res == "success") {
            ...
            var RegisterSnackBar = const SnackBar(
              content:
                  Text('Successfully registered! Login to you account now.'),
            );
